...
- **DPD Updater:** A standalone Go application that handles updates and automatically cleans up duplicate dictionary installations to ensure optimal performance in GoldenDict.
